defmodule CeecWeb.UserLiveTest do
  use CeecWeb.ConnCase

  import Phoenix.LiveViewTest
  import Ceec.AccountsFixtures

  @create_attrs %{confirmed_at: "2025-10-13T06:01:00", email: "some email"}
  @update_attrs %{confirmed_at: "2025-10-14T06:01:00", email: "some updated email"}
